#Finds a range prices in delta t and trades when price leaves that range
...
class OpeningRangeBreakout(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.Consolidate("TSLA", timedelta(minutes=30), self.OnDataConsolidated) #Set consolidator for a 30 minute delta
